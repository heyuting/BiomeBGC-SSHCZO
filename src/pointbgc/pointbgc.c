...
int main(int argc, char *argv[])
{
	...
	, &bgcin.metarrvalues from ini file */
	...
	******************************/
	...
	if (wstate_init(init, &bgcin.sitec, &bgcin.ws, &bgcin.metarr))
	{
	...
	printf("finish reading init file\n");
	...
	printf("finish reading met file\n");
	//added by Y.He to test
	...
	**                  **
	*********************/
	printf("all initialization complete, call model\n");
	...
	free(bgcin.metarr.obs_soilT);
	free(bgcin.metarr.obs_soilW);
